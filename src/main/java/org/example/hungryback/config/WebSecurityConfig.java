    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/api/v1/account/sign-up-app", "/api/v1/account/sign-in", "/api/v1/account/check-certification", "/api/v1/account/sms-certification", "/oauth2/**").permitAll()
